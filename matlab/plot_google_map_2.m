function varargout = plot_google_map_2(varargin)
% 11/28/2016
% Modified to save figure into .jpg file
% By H. Chen @IFT
%
    ...
    for idx = 1:2:length(varargin)
        switch lower(varargin{idx})
            ...
            case 'axis'
                ...
                plotData = get(axHandle,'children'); % tracks
            case 'height'
...
if ~isempty(fileName)
    gps.lat = lat;
    gps.lon = lon;
    ddfPlot(uniImag,latVect,lonVect,plotData,fileName,gps);
end
